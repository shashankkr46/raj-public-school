...
<!-------------------------------------------------------------------------------------------> 
        <div class="row pt-5"> 
            ...
            <div class="col-lg-4">
                 <label for="exampleFormControlFile1" class="overview-para">Upload Photograph</label>
...
<!------------------------------------------------------------------------------------------->
        <div class="row mt-5">
            ...
            <div class="col-lg-4">
                <div><label for="inlineFormCustomSelect" class="overview-para">Current Position<span class="text-danger">*</span></label></div>
            <span class="d-flex flex-row justify-content-start">
                    <select class="custom-select pt-0 pb-0 w-100" id="inlineFormCustomSelect">
            ...
            <div class="col-lg-4">
                <div><label for="inlineFormCustomSelect" class="overview-para">Annual Income<span class="text-danger">*</span></label></div>
            <span class="d-flex flex-row justify-content-start">
                    <select class="custom-select pt-0 pb-0 w-100" id="inlineFormCustomSelect">
...
<div class="row mt-5">
        <div class="col-lg-4">
                   <label for="inlineFormInputGroupUsername" class="label-text">Telephone Home <span class="text-danger">*</span></label>
                    <div class="input-group">
                     <div class="input-group-prepend">
                      <div class="input-group-text">91</div>
                     </div>
        ...
        <div class="col-lg-4">
            <label for="firstname" class="label-text">Email<span class="text-danger">*</span></label>
            <input type="text" class="form-control" >
        </div>
        <div class="col-lg-4">
            <label for="exampleFormControlFile1" class="overview-para">Upload Photograph</label>
            <input type="file" class="form-control-file file-box-1" id="exampleFormControlFile1">
        </div>
</div>
<!------------------------------------------------------------------------------------------->

 <div class="row mt-5">
         <div class="col-lg-12 pl-0"><p class="font-weight-bold pt-3 text-dark">Mother's Particulars</p></div>
        </div>
        <div class="row">
          <div class="col-lg-4">
             <label for="firstname" class="label-text">First name <span class="text-danger">*</span></label>
